...
#define errlist { "Undefined error: 0", "Operation not permitted", "No such file or directory",             \
...
#define errlist { "Success", "Operation not permitted", "No such file or directory", "No such process",     \
        ...
        "Disk quota exceeded", "No medium found", "Wrong medium type", "Operation canceled",                \
